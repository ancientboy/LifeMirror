    ...
    messages: [
      {
        ...
        content: [
          ...
          "shareCards must contain three genuinely different one-line social expressions, each 12-30 Chinese characters and free of technical terms. warm is for sharing as one's own status and should feel personally seen; roast is for sending to a person in the relationship and should create a gentle, answerable tension without accusation; witty invites the recipient to generate their own mirror and compare. Do not create tone-only rewrites, reuse sentence structures, lecture, expose private details, or prefix a style label. Never change the computed conclusion for virality.",
