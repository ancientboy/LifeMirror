...
export function classifyLiuyaoIntents(question: string): LiuyaoIntent[] {
...
export function resolveLiuyaoContext(input: { question: string; occurredAt?: string; timezone?: string }): LiuyaoAnalysisContext {
  ...
  const intents = classifyLiuyaoIntents(input.question.trim());
  return {
