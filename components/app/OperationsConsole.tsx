...
import { ArrowLeft, Check, CircleNotch, ShieldCheck, Sparkle, WarningCircle } from "@phosphor-icons/react";
...
type CoreExperience = { sampleUsers: number; firstConversationContinuationRate: number; eventCreationRate: number; dayOneRetention: number; daySevenRetention: number; realityFeedbackRate: number; memoryAccuracyRate: number; toolContinuationRate: number; shareIntentRate: number; monetizationGate: { minimumSampleReached: boolean; observationWindowDays: number; ready: boolean } };
