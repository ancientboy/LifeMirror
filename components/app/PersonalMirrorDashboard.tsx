...
export function PersonalMirrorDashboard() {
  ...
  const [mirrorStartsInPractice, setMirrorStartsInPractice] = useState(false);
  ...
  return <main className={styles.shell}>
    ...
    {mirrorPerson && <PersonMirror person={mirrorPerson} initialPractice={mirrorStartsInPractice} onClose={() => { setMirrorPerson(null); setMirrorStartsInPractice(false); }} />}
  </main>;
}
